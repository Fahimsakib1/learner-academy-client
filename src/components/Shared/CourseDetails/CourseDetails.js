                ...
                <Card.Body  className='border border-2 border-primary mt-3 course-card-body rounded-3'>
                    <div className=''>
                        ...
                        <Card.Header as="h4" className='text-white text-center border border-2 border-dark rounded-3 course-title-name mb-3'>
                            <div className='d-flex align-items-center justify-content-center flex-column flex-lg-row flex-md-row'>
                                {course_name}
                                <ReactPrint trigger={() => <Button className='ms-3 mt-2' variant="success">
                                        <FaArrowDown className='me-2'></FaArrowDown>Download PDF
                    ...
                    <div ref={ref} className='px-2'>
                        ...
                        <div className='d-flex align-items-center justify-content-center'>
                            <Card.Title className='me-2'>Learn <span className='text-primary fw-bold'>{course_name}</span> with <span className='text-primary fw-bold'>{name}</span></Card.Title>
                            <Image
                                roundedCircle
                                src={instructor_img}
                                style={{ height: "50px" }}
